...
public class ChineseStringDetector extends Detector implements Detector.JavaScanner {
	...
	private static final String ISSUE_ID = "QjoyJavaChineseString";
	private static final String ISSUE_DESCRIPTION = "QjoyJavaChineseString";
	private static final String ISSUE_EXPLANATION = "Check chinese string hardcode in java file";
